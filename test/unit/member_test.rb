...
class MemberTest < ActiveSupport::TestCase
  ...
  test "password should be autogenerated if empty" do
    one_john = Member.create(:name => 'John Locke', :username => 'jlocke', :email => 'jlocke@example.com', :new_organization => 1)
    assert !one_john.clear_password.nil?
    assert_equal one_john.clear_password.length, 8

    another_john = Member.create(:name => 'John Locke', :username => 'johnl', :password => 'secret', :email => 'johnl@example.com', :new_organization => 1)
    assert_equal another_john.clear_password, 'secret'
  end

  test "email addresses should be unique among members" do
    one_john = Member.new(:name => 'John Locke', :username => 'jlocke', :password => 'secret', :email => 'john@locke.com', :new_organization => 1)
    assert one_john.save

    another_john = Member.new(:name => 'John Locke', :username => 'johnl', :password => 'secret', :email => 'john@locke.com', :new_organization => 1)
  ...
  test "bad logins cannot be used" do
    ...
    member = Member.new(:name => "A New Member", :password => "securepassword", :email => "blo@blo.com", :new_organization => 1)
    #too short
    member.username = "x"
    assert !member.save
  ...
  test "create user" do
    ...
    member = Member.new(:name => "newmember", :password => "okpassword", :username => "José Canseco", :email => "mail@blo.com", :new_organization => 1)
    assert member.save
